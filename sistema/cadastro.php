...
//verifico se a função que eu criei existe, vai que alguem pegou meu script e apagou ela = ) kkk
if(!function_exists("func_conexao")) {
  echo "Erro o arquivo conexao.php foi alterado, nao existe a função func_conexao";
exit;
}

func_conexao();
$sql = mysqli_query($conexao,"SELECT * FROM TB_Usuario") or die ("Erro");
